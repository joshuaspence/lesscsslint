...
module.exports.lintCSS = function(inputPath, input, ruleset, callback) {
    var results = csslint.verify(input, ruleset);
 ...
 */
module.exports.lintLESS = function(inputPath, input, ruleset, callback) {
